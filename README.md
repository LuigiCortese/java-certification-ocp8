...
9. **Java File I/O (NIO.2)**
  ...
  * Use Files class to check, read, delete, copy, move, manage metadata of a file or directory.**[[1]](09_JavaFileIO-NIO2/src/main/java/net/devsedge/files/getriter/App.java)** ~~Use FileVisitResult, PathMatcher, OpenOption, FileSystems.~~
